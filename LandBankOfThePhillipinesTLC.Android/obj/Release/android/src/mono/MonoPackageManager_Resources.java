...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "LandBankOfThePhillipinesTLC.Android.dll" comes first in this list. */
		"LandBankOfThePhillipinesTLC.Android.dll",
		"Acr.UserDialogs.dll",
		"AndHUD.dll",
		"DryIoc.dll",
		"FormsViewGroup.dll",
		"LandBankOfThePhillipinesTLC.dll",
		"Newtonsoft.Json.dll",
